...
// import { useTranslation } from '@/hooks/useTranslation'; // Mocked
// import { useResponsiveSize } from '@/hooks/useResponsiveSize'; // Ignored
...
const MenuItem: React.FC<MenuItemProps> = ({
    ...
    const _ = (key: string) => key; // Simple mock
    const iconSize = 16;
    const IconType = Icon || (toggled !== undefined ? (toggled ? Check : undefined) : undefined);
                ...
                <div className='flex min-w-0 items-center'>
                    {!noIcon && (
                        <span style={{ minWidth: `${iconSize}px` }}>
                            {typeof IconType === 'function' || (typeof IconType === 'object' && IconType !== null) ? (
                                // @ts-ignore
                                <IconType
