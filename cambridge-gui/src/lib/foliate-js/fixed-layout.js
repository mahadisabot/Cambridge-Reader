    ...
    async #createFrame({ index, src: srcOption }) {
        ...
        return new Promise(resolve => {
            iframe.addEventListener('load', () => {
                console.log("FixedLayout: iframe loaded for index", index);
            ...
            if (data) {
                console.log("FixedLayout: loading iframe with srcdoc");
                iframe.srcdoc = data
            } else {
                console.log("FixedLayout: loading iframe with src:", src);
                iframe.src = src
            }
        })
    }
