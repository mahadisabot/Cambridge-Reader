    ...
    async load(src, data, afterLoad, beforeRender) {
        ...
        return new Promise(resolve => {
            this.#iframe.addEventListener('load', () => {
                console.log("InternalView: Iframe LOAD event fired! Src:", this.#iframe.src);
            ...
            if (data) {
                ...
                // DEEP INSPECTION
                console.log("InternalView DEBUG: Data Type:", typeof data);
                console.log("InternalView DEBUG: Data Length:", data?.length);

                this.#iframe.src = src // FORCE SRC
            } else {
                this.#iframe.src = src
            }
        })
...
customElements.define('foliate-paginator-v4', Paginator)
