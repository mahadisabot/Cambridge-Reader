...
class View {
    ...
    constructor({ container, onExpand }) {
        ...
        // this.#iframe.style.display = 'none' // display:none can block loading
        this.#iframe.style.visibility = 'hidden';
        this.#iframe.style.border = '0'
        Object.assign(this.#iframe.style, {
            overflow: 'hidden',
            // border: '0', // Moved above
            // display: 'none', // Changed to visibility:hidden
        ...
        this.#iframe.removeAttribute('sandbox'); // DEBUG: Remove sandbox to test CSP
    ...
    async load(src, data, afterLoad, beforeRender) {
        console.log("InternalView: load() called. Src:", src);
        console.log("InternalView: data present?", !!data, "Length:", data?.length);
        if (typeof src !== 'string') throw new Error(`${src} is not string`)
        return new Promise(resolve => {
            console.log("InternalView: adding load listener to iframe");
            this.#iframe.addEventListener('load', () => {
                console.log("InternalView: iframe load event FIRED");
