...
export class View extends HTMLElement {
    ...
    async open(book) {
        ...
        console.log("View.js: open() called. isFixedLayout:", this.isFixedLayout);
        if (this.isFixedLayout) {
            console.log("View.js: Importing FixedLayout...");
            if (!customElements.get('foliate-fxl')) await import('./fixed-layout.js')
            this.renderer = document.createElement('foliate-fxl')
        } else {
            console.log("View.js: Importing Paginator (v4 REGISTRY BYPASS)...");
            if (!customElements.get('foliate-paginator-v4')) await import('./paginator-v4.js')
            console.log("View.js: Creating Paginator element (v4)...");
            this.renderer = document.createElement('foliate-paginator-v4')
            console.log("View.js: Paginator element created:", this.renderer);
        }
        ...
        console.log("View.js: calling renderer.open()...");
        this.renderer.open(book)
        console.log("View.js: renderer.open() returned. Appending to root...");
        this.#root.append(this.renderer)
        console.log("View.js: Appended to root.");
    ...
    goToTextStart() {
        console.log("View.js: goToTextStart called");
    ...
    async init({ lastLocation, showTextStart }) {
        console.log("View.js: init() called. showTextStart:", showTextStart);
